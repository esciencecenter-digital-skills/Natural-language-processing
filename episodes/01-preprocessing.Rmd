...
We proceed to load our models. We will dynamically read all model files from the folder and organizing them into lists based on their decades.
...
# Create a dictionary to hold the models grouped by decade
models_by_decade = defaultdict(list)

# Regular expression pattern to extract the decades / these are in the format: name_start-year_end-year.w2v
...
for filename in filenames:
    ...
    if match:
        ...
        # Create a key for the decade, e.g., 'models_50_59'
        decade_key = f"models_{str(start_year)[2]}0_{str(end_year)[2]}9"
        models_by_decade[decade_key].append(filename)

# Sort the decades
decades = sorted(models_by_decade.keys())

```

Next we will create a list of models:

```python
models = [models_by_decade[decade] for decade in decades]
```
...
```python
models_60_69: ['parool_1960_1969.w2v', 'trouw_1960_1969.w2v', 'vk_1960_1969.w2v', 'ah_nrc_1960_1969.w2v', 'vv_1960_1969.w2v', 'telegraaf_1960_1969.w2v']
models_80_89: ['parool_1980_1989.w2v', 'trouw_1980_1989.w2v', 'vk_1980_1989.w2v', 'ah_nrc_1980_1989.w2v', 'vv_1980_1989.w2v', 'telegraaf_1980_1989.w2v']
models_70_79: ['vk_1970_1979.w2v', 'trouw_1970_1979.w2v', 'parool_1970_1979.w2v', 'telegraaf_1970_1979.w2v', 'vv_1970_1979.w2v', 'ah_nrc_1970_1979.w2v']
models_50_59: ['trouw_1950_1959.w2v', 'parool_1950_1959.w2v', 'vk_1950_1959.w2v', 'telegraaf_1950_1959.w2v', 'vv_1950_1959.w2v', 'ah_nrc_1950_1959.w2v']
```
