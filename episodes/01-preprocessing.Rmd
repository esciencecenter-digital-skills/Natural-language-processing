...
# Introduction
In this episode, we’ll go over the concept of word embedding, and the steps to generate and explore it with Word2vec. 

The goal of this episode is to get you hands-on experience, without diving into the technical or mathematical intricacies 
of neural networks. We want you to complete the full workflow of building and using word embeddings 
before diving into what are those. In the later episodes we will build upon this knowledge to go deeper into all of these steps.


# Formulate the problem
In this episode we will be using Dutch newpaper texts from [Delpher](https://www.delpher.nl/). 
Newspapers make an interesting dataset for scientific research, as it contains information about current events 
and the language it uses is clear and reflective of its time.

Delpher is a public database developed by the [KB - the National Library of the Netherlands](https://www.kb.nl/) and 
contains digitalised historic Dutch newspapers, books, and magazines. 
The online newspaper collection covers data spanning from 1618 up to 1995 and of many local, national and 
international publishers. 

What we will be looking into is to examine the semantic shifts of specific words over various decades. We will look at the context in which a word is used between the 1950s and 1990s.

We will be using this dataset to train a Word2Vec model to investigate the notion of *semantic shift*.
...
in a word simoultaneously (English "head", as in "I have covered my head with a hat" and as in "I am the head of the department").


We will specifically look at the evolution of specific words in Dutch across a period of time from 1950 to 1990.
